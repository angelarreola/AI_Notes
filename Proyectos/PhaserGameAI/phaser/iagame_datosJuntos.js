...
function iniciarRedNeural() {
  ...
  nnNetwork = new synaptic.Architect.Perceptron(5, 12, 12, 2); //? Funciona con las entradas no separadas.
...
async function gestionarMovimientoJugador() {
  if (modoAuto) { //? Modo Automatico
    ...
    if (jugadorD) {
      ...
      } else if (nnSalida[1] > 1 && nnSalida[1] <= UMBRAL_BAJO) { //+ Si la red decide "moverse a la izquierda"
