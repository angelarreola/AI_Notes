...
function datosDeEntrenamiento(param_entrada){
    ...
    var act=Math.round( nnSalida[0]*100 );

    // var aire=Math.round( nnSalida[0]*100 );
    // var piso=Math.round( nnSalida[1]*100 );
    console.log("Valor ","En el Aire %: "+ act );
    return 70 < act;
}
...
function update() {
    ...
    if( modoAuto ==false  && bala.position.x > 0 ){
        ...
        // console.log("Desplazamiento Bala, Velocidad Bala, Estatus, Estatus: ", despBala + " " +velocidadBala + " "+ estatusAire+" "+  estatuSuelo);
        console.log(despBala + " " + velocidadBala + " " + estatus);
   }
